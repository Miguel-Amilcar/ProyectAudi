...
public partial class ProyectDbContext : DbContext
{
    ...
    public virtual DbSet<RECUPERACION_CONTRASENA> RECUPERACION_CONTRASENA { get; set; }
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<BITACORA_DETALLE>(entity =>
        {
            ...
            entity.HasOne(d => d.BITACORA).WithMany(p => p.BITACORA_DETALLE)
        ...
        modelBuilder.Entity<BITACORA_ENCABEZADO>(entity =>
        {
            ...
            entity.HasOne(d => d.OPERACION).WithMany(p => p.BITACORA_ENCABEZADO)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__BITACORA___OPERA__7A672E12");

            entity.HasOne(d => d.TABLA).WithMany(p => p.BITACORA_ENCABEZADO)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__BITACORA___TABLA__797309D9");

            entity.HasOne(d => d.USUARIO_AFECTADO).WithMany(p => p.BITACORA_ENCABEZADOUSUARIO_AFECTADO).HasConstraintName("FK__BITACORA___USUAR__787EE5A0");

            entity.HasOne(d => d.USUARIO).WithMany(p => p.BITACORA_ENCABEZADOUSUARIO)
                .OnDelete(DeleteBehavior.ClientSetNull)
        ...
        modelBuilder.Entity<CREDENCIAL>(entity =>
        {
            ...
            entity.HasOne(d => d.USUARIO).WithMany(p => p.CREDENCIAL)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_CREEDENCIAL_USUARIO");
        });
        ...
        modelBuilder.Entity<PERMISO>(entity =>
        {
            ...
            entity.HasOne(d => d.ROL).WithMany(p => p.PERMISO)
                .OnDelete(DeleteBehavior.ClientSetNull)
        ...
        {
            entity.HasKey(e => e.RECUPERACION_ID).HasName("PK__RECUPERA__DEC49DA8CEC75799");

            entity.ToTable(tb => tb.HasTrigger("TRG_RECUPERACION_AUDITORIA"));

            entity.Property(e => e.FECHA_SOLICITUD).HasDefaultValueSql("(getdate())");

            entity.HasOne(d => d.CREDENCIAL).WithMany(p => p.RECUPERACION_CONTRASENA)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_RECUPERACION_CREDENCIAL");
        });
        ...
        modelBuilder.Entity<ROL>(entity =>
        {
            ...
            entity.HasOne(d => d.USUARIO).WithMany(p => p.ROL)
                .OnDelete(DeleteBehavior.ClientSetNull)
